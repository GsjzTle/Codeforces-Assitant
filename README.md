...
1. 查询 tables_group 所有成员的 rating
2. 查询 tables_group 所有成员本周 ac排名
3. 查询 codeforces 即将开始的比赛
...
打开 `go-cqhttp` 下的 `config.yml` 进行配置。
...
servers:
  ...
  - http: # HTTP 通信设置
      ...
      post:           # 反向HTTP POST地址列表
        - url: 'http://127.0.0.1:5705/' # url用来发送信息，可自己设置其它地址
        #  secret: ''           # 密钥
